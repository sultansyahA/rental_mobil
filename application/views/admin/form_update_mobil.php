                    ...
                    <div class="form-group">
                        ...
                        <select name="kode_type" class="form-control">
                          ...
                          <?php foreach($type as $tp) : ?>
                              <option value="<?php echo $tp->kode_type ?>"><?php echo $tp->nama_type ?><?php echo $tp->nama_type ?></option>
                          <?php endforeach; ?>  
                        </select>
                       ...
                       <div class="form-group">
                        <label>AC</label>
                        <select name="ac" class="form-control">value=<?php echo $mb->ac ?>">
                       ...
                       <div class="form-group">
                        <label>Status</label>
                        <select name="status" class="form-control">value=<?php echo $mb->warna ?>">
                       ...
                       <div class="form-group">
                        <label>Supir</label>
                        <select name="supir" class="form-control">value=<?php echo $mb->warna ?>">
                       ...
                       <div class="form-group">
                        ...
                        <select name="mp3_player" class="form-control">value=<?php echo $mb->warna ?>">
                       ...
                       <div class="form-group">
                        ...
                        <select name="central_lock" class="form-control">value=<?php echo $mb->warna ?>">
