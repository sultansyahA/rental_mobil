			...
			<div class="card" style="margin-top: 150px;">
				...
				<div class="card-body">
					<p class="text-success mb-3">Silahkan Melakukan Pembayaran Melalui Nomor Rekening di Bawah Ini:</p>
					  ...
					  <li class="list-group-item">Bank Mandiri 1681738</li>
					  <li class="list-group-item">Bank BCA 1637813</li>
					  <li class="list-group-item">Bank BNI 1658235</li>
					</ul>

					<?php

					if(empty($tr->bukti_pembayaran)) { ?>
					<button style="width: 100%" type="button" class="btn btn-danger mt-3" data-toggle="modal" data-target="#exampleModal">
...
<!-- Modal untuk pluad bukti pembayaran -->
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Upluad Bukti Pembayaran Anda</h5>
      ...
      <div class="modal-body">
        <div class="form-group">
        	<label>Upluad Bukti Pembayaran</label>
